/* Modified version of the package, 'cfb' (https://www.npmjs.com/package/cfb), by MomoCow (http://momocow.me) */
/*
...
if(typeof Buffer !== "undefined") {
	...
	__toBuffer = function(bufs) { bufs[0] = bufs[0].filter((e)=>{return Boolean(e);});return (bufs[0].length > 0 && Buffer.isBuffer(bufs[0][0])) ? Buffer.concat(bufs[0]) : ___toBuffer(bufs);};
